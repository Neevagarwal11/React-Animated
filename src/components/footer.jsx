...
function footer() {
  return (
    <div className='w-full h-screen bg-[#F1F1F1] p-20 rounded-t-xl flex gap-5'>
        <div className="font-['founders'] w-1/2 text-9xl uppercase leading-none flex flex-col justify-between h-full  ">
            <div className="heading">
            <h1 className='-mb-[2vw]'>Eye-</h1>
            <h1>Opening</h1>
            </div>
             <svg
          width="72"
        ...
        <div className="w-1/2">
        <h1 className='-mb-[2vw] text-9xl uppercase leading-none font-["founders"]'>Presentations</h1>
            <h5 className='mt-[4vw] font-["neue"] mb-4'>S:</h5>
            {[{name:"Instagram", url:"https://ochi.design/"},
                {name:"Behance",url:"https://tailwindcss.com/docs/background-image"}, 
                {name:"Facebook", url:"https://tailwindcss.com/docs/background-image"},
                {name:"Linkedin",url:"https://tailwindcss.com/docs/background-image"}].map((item,index) => (
                <a href={item.url} key={index} className='flex column underline font-["neue"] text-[1.1vw]'>{item.name}</a>
            ))}
        </div>
    </div>
  )
